...
from RPA.creators.variables.variables import photos_folder, excel_path


def invoice_creator(id, first_name, last_name, address, consumption, tariff):
    ...
    worksheet = writer.add_worksheet(name="Invoice")
